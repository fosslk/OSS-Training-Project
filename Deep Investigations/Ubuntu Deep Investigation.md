...
##
- Ubuntu has always been free to download, use, and share. It is a typical example of an Open source product. Ubuntu is one of the most secure operating systems around with a built-in firewall and virus protection software.
- The OS has multiple flavours that each have a large community.
- Ubuntu is visually stunning, and you can customise your interface if you want to. The latest version uses the GNOME desktop environment, which allows you to personalize virtually every single element of your UI/UX, from your notification sounds, popup style, fonts, system animations, and workspaces.
...
Ubuntu relies on the GNOME desktop environment for its appearances and can be further tweaked to match end-users preferences. Even though it is easy to use, it may not prove to be a familiar user interface if you’re coming from a Windows platform. In that case, you can try out some official flavours of Ubuntu like Kubuntu, Lubuntu to get a Windows-like user interface. Ubuntu also comes pre-installed with essential tools to get a head start. 
...
- # Low system requirements. (Sankalpani)
...
There two types of Ubuntu flavours; official and unofficial. The differences between official Ubuntu flavour and unofficial Ubuntu flavour are the following.

- Official flavours are customized by the same company which develops the original Ubuntu while unofficial flavours are customized by third parties or communities.
- Same as the original Ubuntu, official flavours are also distributed under the GPL license. Unofficial flavours may or may not be available under the GPL license.
- Official flavours are customized based on the general requirements while unofficial flavours are customized based on the particular requirements of the company or community which customize them.
- Official flavours are available to download and use for everyone. Unofficial flavours may or may not be available for everyone. The company or community, who customizes them, decides whether they will be available for everyone or not.
...
Lubuntu is a light, fast, and modern Ubuntu flavour using LXQt as its default desktop environment. Lubuntu used to use LXDE as its default desktop environment.
...
Ubuntu Studio is a multimedia content creation flavour of Ubuntu, aimed at the audio, video and graphic enthusiast or professional.
...
- Wide range of supported apps and software. (Mewni)
...
**Ubuntu desktop is really useful for people like sysadmins. There is a major server release of ubuntu. So if the organization use Ubuntu as the server-side os and for the desktop os, sysadmins can easily use the same commands to complete their day to day activities in desktop.** 
...
**You can edit your photos or create professional illustrations and designs with tools like Gimp and Krita, available in the Ubuntu Software centre.**
...
![Welcome window](Ubuntu%20Deep%20Investigation.001.png)
...
![Select install size, updates and third part software](Ubuntu%20Deep%20Investigation.002.png)
...
![Set up storage configuration](Ubuntu%20Deep%20Investigation.003.png)
...
![Write changes to disks](Ubuntu%20Deep%20Investigation.002.png)
...
![Where are you](Ubuntu%20Deep%20Investigation.002.png)
...
![Username and password entry](Ubuntu%20Deep%20Investigation.003.png)
...
![Installer running in the background](Ubuntu%20Deep%20Investigation.004.png)
...
![screenshot](Ubuntu%20Deep%20Investigation.005.jpeg)
